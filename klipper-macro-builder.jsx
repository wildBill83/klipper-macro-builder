...
export default function KlipperMacroBuilder() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">
            <h2 className="text-2xl font-bold text-white mb-4">🚀 START_PRINT Options</h2>
                    ...
                    {(startOptions.pressureAdvance || startOptions.velocityLimits) && (
                      <div className="ml-6 mb-3 p-2 bg-yellow-900/30 rounded border border-yellow-500/30">
                        <p className="text-xs text-yellow-200">
                          ⚠️ <strong>Note:</strong> Most slicers (OrcaSlicer, PrusaSlicer, SuperSlicer) already handle pressure advance and velocity/acceleration limits per filament. 
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">
            <h2 className="text-2xl font-bold text-white mb-4">🏁 END_PRINT Options</h2>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20 mb-6">
          ...
          >
            <h2 className="text-2xl font-bold">⚙️ Material-Specific Settings</h2>
              ...
              <table className="w-full text-white text-sm">
                <thead>
                  <tr className="bg-white/10">
                    ...
                    <th className="p-2 text-left">Chamber (°C)</th>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-bold text-white">📝 Generated Macros</h2>
            <button
          ...
          <div className="mt-4 p-4 bg-blue-900/30 rounded-lg border border-blue-500/30">
            <h3 className="text-lg font-semibold text-blue-300 mb-3">📋 Setup Instructions (Follow in Order)</h3>
...
END_PRINT
              ...
              <div className="bg-green-900/30 p-3 rounded border border-green-500/30">
                <h4 className="font-semibold text-green-200 mb-2">✅ You're Ready!</h4>
